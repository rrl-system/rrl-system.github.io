...
import './tariff-plans-section-1.mjs';
import '../../../../components/buttons/aside-button.mjs';

class TariffPlans extends BaseElement {
    static get styles() {
        return [
            css`
                :host {
    ...
    render() {
        return html`
            <tariff-plans-section-1></tariff-plans-section-1>
        `;
    }
...
customElements.define("tariff-plans", TariffPlans);