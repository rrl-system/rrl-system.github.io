...
import './my-notifications-section-1.mjs';
// import '../../../../components/button/aside-button.mjs';

class MyNotifications extends BaseElement {
    static get styles() {
        return [
            css`
                :host {
    ...
    render() {
        return html`
            <my-notifications-section-1></my-notifications-section-1>
        `;
    }
...
customElements.define("my-notifications", MyNotifications);