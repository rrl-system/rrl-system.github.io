...
class MyProjectsSection1Page1 extends BaseElement {
        ...
        async PredictModel() {
            ...
            return fetch(`http://cs.rsu.edu.ru:4500/api/learn-model/${projectId}`, {
                method: "POST",
                headers: {
                  'Authorization': `Bearer ${token}`,
                  'Content-Type': 'application/json;charset=utf-8'
        ...
        async LearnModel() {
            ...
            return fetch(`http://cs.rsu.edu.ru:4500/api/learn-model/${projectId}?epochs=${this.project.epochs}`, {
                headers: {
                  'Authorization': `Bearer ${token}`,
