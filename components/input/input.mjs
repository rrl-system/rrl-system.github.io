...
class RrlInput extends RrlElement {
    ...
    get #icon() {
        return html`
            <rrl-icon class="icon" icon="{}" name="lock" fill="${this.fill}" size="${this.size}" scale="1" rotate="0" speed="0" blink="0" blval="1;0;0;1" path=""></rrl-icon>
        `
    }
    ...
    get #button() {
        return html`
            <rrl-icon class="button" icon="{}" name="eye-regular" fill="${this.fill}" size="${this.size}" scale="1" rotate="0" speed="0" blink="0" blval="1;0;0;1" path="" @click=${this.updateLoginValue}></rrl-icon>
        `
    }
    get #button1() {
        return html`
